<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PBooking.aspx.cs" Inherits="FullCalendarT.PBooking" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <iframe id="frmBooking-iframe" class="flex-grow-1" src="frmBooking.aspx" height="100%" width="100%"></iframe>
        </div>
    </div>
    <script>
        // เมื่อหน้าจอโหลดเสร็จ กำหนดความสูงและความกว้างของ iframe ให้เท่ากับความสูงและความกว้างของหน้าจอ
        window.onload = function () {
            var iframe = document.getElementById("frmBooking-iframe");
