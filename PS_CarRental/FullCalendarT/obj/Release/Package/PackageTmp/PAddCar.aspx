<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="PAddCar.aspx.cs" Inherits="FullCalendarT.PAddCar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            <iframe id="addcar-iframe" class="flex-grow-1" src="frmAddCar.aspx" height="100%" width="100%"></iframe>
        </div>
    </div>
    ...
    <script>
        ...
        window.onload = function () {
            var iframe = document.getElementById("addcar-iframe");
